...
export default function EditFormReportPdm({ reportPdm }) {
    ...
    const { data, setData, get, put, errors, reset } = useForm({
        ...
        pic_masterspec: auth.user.name,
        tgl_done_masterspec: reportPdm.tgl_done_masterspec ?? formatDateNow(),
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route("report-pdm.update", reportPdm.id), {
            onSuccess: () => {
                reset();
                Swal.fire({
                    title: "Success!",
                    text: "Data Masterspec has created successfully!",
                    icon: "success",
                ...
                <Container>
                    <div className="p-6 bg-gray-800 flex flex-col items-center text-white w-full rounded-xl">
                        <h1 className="text-xl font-semibold mb-4">
                            Edit Report PDM - {auth.user.roles[0].name}
                        </h1>
                        <form onSubmit={handleSubmit}>
                            <div className="grid grid-cols-2 gap-10 mb-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    {/* TGL DONE WIP CURING AND BUILDING */}
                                    <div className="grid grid-cols-[180px_1fr] items-center gap-4">
                                        <label className="text-white font-semibold">
