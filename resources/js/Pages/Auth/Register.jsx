...
export default function Register() {
    ...
    return (
        <GuestLayout>
            <Head title="Register" />
            <h1 className="text-4xl text-center font-bold my-4">REGISTER</h1>
            ...
            <form onSubmit={submit}>
                ...
                <button
                    type="submit"
                    className="mt-4 w-full bg-teal-500 flex justify-center items-center px-4 py-2 rounded-md font-medium text-white text-lg hover:bg-sky-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={processing}
                >
                    Register
                </button>
